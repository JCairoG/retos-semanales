...
class Dialog{
  ...
  showWait (message, title, textAlign = DialogTextAlign.CENTER){
    dlg.style.backgroundColor = typeProps[DialogType.INFO].color;
    dlgTitle.innerHTML = title;
    dlgImage.style.display ="none";
  ...
  closeWait (message, title, textAlign = DialogTextAlign.CENTER){
    dlgOverlay.style.display = "none";
    dlg.classList.toggle("dialog--visible");
  }

  show(message="", title="", type = DialogType.INFO, buttons = DialogButtons.ACEPT, textAlign = DialogTextAlign.CENTER){
    let btnText ="";
    let btnText2 ="";
    let btnText3 ="";
    let btnFocus = 1;
    ...
    dlgImage.style.display ="initial";
    dlgMessage.innerHTML = message;
    dlgMessage.style.textAlign = textAlign;
